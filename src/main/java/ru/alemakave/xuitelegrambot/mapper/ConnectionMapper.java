...
public abstract class ConnectionMapper {
    ...
    public abstract ConnectionGetUpdateDTO connectionToConnectionGetUpdateDto(Connection connection) throws JsonProcessingException;

    public Connection connectionGetUpdateDtoToConnection(ConnectionGetUpdateDTO connectionDto) throws JsonProcessingException {
